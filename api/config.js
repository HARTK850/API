export const SYSTEM_CONSTANTS = {
    ...
    PROMPTS: {
        ...
        GAME_START: "t-ברוכים הבאים לעוזיר קליק! נתחיל בשאלה הראשונה.", 
        ...
        SETTINGS_MENU: "t-תפריט הגדרות. להגדרת רמת פירוט התשובה הקישו 1. להקלטת הנחיות קבועות הקישו 2. להקלטת פרופיל אישי הקישו 3. לחזרה הקישו 0.",
